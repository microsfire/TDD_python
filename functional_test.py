...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # Ela percebe que o titulo da página e o cabeçalho mencionam listas de tarefas (to-do)
...
# Ainda continuando uma caixa de texto convidando-a a acrescentar outro item
# Ela insere "Use peacock feathers to make a fly" (Usar penas de pavão para fazer um fly)
...
# Ela acessa essa URL - sus lista de tarefas continua lá.
